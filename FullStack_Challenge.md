...
- [ ] [Finish the backend challenge](./amazon-server/Backend_Challenge.md)
- [ ] [Finish the frontend challenge](./amazon-front/Frontend_Challenge.md)
- [ ] Integrate them, so your frontend code consumes your backend APIs

## Extras

- [ ] For the backend extra points, [read here](./amazon-server/Backend_Challenge.md#extras)
- [ ] For the frontend extra points, [read here](./amazon-front/Frontend_Challenge.md#extras)
